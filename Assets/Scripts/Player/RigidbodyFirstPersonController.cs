...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class RigidbodyFirstPersonController : MonoBehaviour
    {
        ...
        {
            public float groundCheckDistance = 0.01f; // I changed this to 0.1 to keep from getting stuck on hills - BK; distance for checking if the controller is grounded ( 0.01f seems to work best for this )
